...
" Based Off Of: Herald by Fabio Cevasco <h3rald@h3rald.com>
...
elseif &t_Co == 256
	...
	" -> Tabs
	hi TabLine        ctermbg=233  ctermfg=Gray   cterm=none
	hi TabLineFill    ctermbg=234                     cterm=none
	hi TabLineSel     ctermbg=234  ctermfg=White      cterm=bold
	"
	" -> Visual Mode
