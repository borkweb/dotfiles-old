...
function! s:PHPCustomFolds() " {{{
	...
	call s:PHPFoldProperties('^\s*public\s\$', ";", s:FOLD_WITH_PHPDOC, 1, 1)
	call s:PHPFoldProperties('^\s*private\s\$', ";", s:FOLD_WITH_PHPDOC, 1, 1)
	call s:PHPFoldProperties('^\s*const\s', ";", s:FOLD_WITH_PHPDOC, 1, 1)
